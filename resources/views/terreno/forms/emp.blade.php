...
<div class="card-body">
	...
	<div class="col-md-6">
		...
		{!!Form::text('user_id',null,['id' => 'user_id','required' => '','class'=>'form-control','placeholder'=>'Ingresa el nombre de usuario'])!!}
	</div>
	...
	<div class="col-md-6">
		...
		{!!Form::select('culture_id', array('Maiz' => 'Maiz', 'Calabacita' => 'Calabacita','Frijol' => 'Frijol', 'Ajo' => 'Ajo'), null, ['id'=>'culture_id','class' => 'js-example-basic-single js-states form-control']);!!}
	</div>
