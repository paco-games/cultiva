...
<html>
<head>
<title>Agrox a Agriculture Category Flat Bootstrap Responsive Website Template | Codes :: w3layouts<</title>
<!---css--->
			...
			<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li><a href="index.html" class="wow fadeInDownBig" data-wow-delay=".1s">Home <span class="sr-only">(current)</span></a></li>
								<li><a href="about.html" class="wow fadeInDownBig" data-wow-delay=".2s">About</a></li>
								<li><a href="services.html" class="wow fadeInDownBig" data-wow-delay=".4s">Services</a></li>
								<li><a href="gallery.html" class="wow fadeInDownBig" data-wow-delay=".6s">Gallery</a></li>
								<li class="active"><a href="codes.html" class="wow fadeInDownBig" data-wow-delay=".7s">Codes</a></li>
								<li><a href="contact.html" class="wow fadeInDownBig" data-wow-delay=".9s">Contact</a></li>
							</ul>
						</div>
					</div>
				</nav>
	...
	<div class="pages">
		<div class="container">
			...
			<div class="typo-bottom">
				<div class="headdings wow fadeInRight animated" data-wow-delay=".5s">
				...
				<div class="Buttons wow fadeInLeft animated" data-wow-delay=".5s">
				...
				<div class="progress-bars wow fadeInRight animated" data-wow-delay=".5s">
				...
				<div class="bread-crumbs wow fadeInLeft animated" data-wow-delay=".5s">
				...
				<div class="pagenatin wow fadeInRight animated" data-wow-delay=".5s">
				...
				<div class="alerts wow fadeInLeft animated" data-wow-delay=".5s">
				...
				<div class="distracted wow fadeInRight animated" data-wow-delay=".5s">
			...
			<div class="appearance wow fadeInLeft animated" data-wow-delay=".5s">
