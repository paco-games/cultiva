                            ...
                            <table id="datatable" class="table table-striped table-hover" data-swftools="assets/js/libs/DataTables/extensions/TableTools/swf/copy_csv_xls_pdf.swf">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort-numeric">Calendario al Tercer Trimestre</th>
                                        <th class="sort-numeric">Total Ejercido</th>
                                        <th class="sort-numeric">Saldo (Calendario 1er Trimestre vs Ejercido)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($generalsaldo as $dato)
                                    <tr class="gradeX">
