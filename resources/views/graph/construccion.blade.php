...
<div id="container" style="min-width: 100px; height: 460px; margin: 0 auto"></div>
...
<div class="col-lg-12">
                        <div class="table-responsive">
                            <table id="datatable" class="table table-striped table-hover" data-swftools="assets/js/libs/DataTables/extensions/TableTools/swf/copy_csv_xls_pdf.swf">
                                ...
                                <tbody>
                                @foreach($workConstruction as $dato)
                                    <tr class="gradeX">
                                      <td >{{substr($dato->stateConstruction->estado, 0,3)." - ".$dato->carretera}}</td>
