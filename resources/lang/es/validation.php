...
return [
    ...
    */
    ...
    'custom' => [
        'attribute-name' => [
            ...
            'contract_supervision_id' => 'Contrato de Supervision',
            'contract_work_id' => 'Contrato de Obra',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        //Empresas
        'nameemp'           => 'Nombre de la Empresa',
        'legalagent'        => 'Representante Legal',
        'type'              => 'tipo de',
        'status'            => 'Estatus',
        ...
        'celphone'          => 'Celular',
        'password'          => 'Contraseña',
        'pathperfil'        => 'Imagen de Perfil',
        //Integración EP
        'ep'                => 'Especificación Particular',
        'nameInteg'         => 'description',
        'description'       => 'Descripción',
        'weight'            => 'Tamaño del Archivo',
        'route'             => 'Ruta a Guardar',
        //Compromisos Gubernamentales
        'codeCG'             => 'Compromiso Gubernametal',
        'nameCommitment'             => 'Nombre del Compromiso Gubernametal',
        //Contracto de Obra
        'amount'  => 'Monto',
        'numberTender'  => 'Número de Licitación',
        'numberContract'  => 'Número de Contrato',
        'placeTender'  => 'Lugar de Licitación',
        'nameWork'  => 'Nombre del Contrato de Obra',
        'descriptionWork'  => 'Descripción del Contrato de Obra',
        'dateFailure'  => 'Fecha de Fallo',
        'dateAdjudication'  => 'Fecha de Adjudicación',
        //Contratos de empresas
        'contract_id'  => 'Contrato de Obra',
        'enterprise_id'  => 'Empresa',
        //
        'contract_supervision_id' => 'Contrato de Supervisión',
        'contract_work_id'  => 'Contrato de Obra',
        //Ep8
        'priority' =>'Listado problematicas',
        'fileNamEp8'=>'Nombre del archivo'
